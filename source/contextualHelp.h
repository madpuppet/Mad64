...
extern const char* gHELP_CIA1_DATAPORTA[];
extern const char* gHELP_CIA1_DATAPORTB[];
extern const char* gHELP_CIA1_INTCONTROL[];
extern const char* gHELP_CIA1_CONTROLTIMERA[];
extern const char* gHELP_CIA1_CONTROLTIMERB[];
