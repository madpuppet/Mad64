...
#ifndef DMFastDelegate_H
#define DMFastDelegate_H
#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
...
#define DELEGATE(FUNC) DMFastDelegate::MakeDelegate(this, &FUNC)
#define DELEGATE_EX(OBJ,FUNC) DMFastDelegate::MakeDelegate(OBJ, &FUNC)
